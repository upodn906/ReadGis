...
namespace Reader.Infrastructures.Clients
{
    public class EdsabClient : BaseGisClient
    {
        ...
        {
            //Logger.LogInformation($"{Configuration.Address}/{layer.Id}/query?where=+{objectIdFieldName}>={startObjectId} and {objectIdFieldName}<={endObjectId}&text=&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&relationParam=&outFields=*&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=4326&returnIdsOnly=false&returnCountOnly=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&returnZ=false&returnM=false&gdbVersion=&returnDistinctValues=false&f=pjson");

            //Console.WriteLine($"{Configuration.Address}/{layer.Id}/query?where=+{objectIdFieldName}>={startObjectId} and {objectIdFieldName}<={endObjectId}&text=&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&relationParam=&outFields=*&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=4326&returnIdsOnly=false&returnCountOnly=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&returnZ=false&returnM=false&gdbVersion=&returnDistinctValues=false&f=pjson");

            return $"{Configuration.Address}/{layer.Id}/query?where=+{objectIdFieldName}+%3E=+{startObjectId}%20and%20{objectIdFieldName}+%3C=+{endObjectId}&text=&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&relationParam=&outFields=*&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=4326&returnIdsOnly=false&returnCountOnly=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&returnZ=false&returnM=false&gdbVersion=&returnDistinctValues=false&f=pjson";
        }
